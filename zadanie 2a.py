# -*- coding: utf-8 -*-
"""
Created on Sun Nov  8 00:22:34 2020
...
modul1,Mlogarytm1,k1,fk1=DFT(z,k1,N,fs)
czasdft4 =datetime.datetime.now()

c3=czasdft4-czasdft3
print('zadanie 2a dft:')
print(c3)
...
plt.plot(k1,modul1)
plt.title("Zadanie 2a liniowe")
plt.show()

plt.plot(fk1,Mlogarytm1)
plt.title("Zadanie 2a logarytmicznie")
plt.show()
